...
module.exports = {
  ...
  convertVideo: (video) => ({
    ...
    [FIELDS.IMAGE]: video.image,
    [FIELDS.IMAGE_NAME]: video.imagename,
    [FIELDS.ARTIST]: video.artist,
  ...
  convertArticle: (article) => ({
    ...
    [FIELDS.IMAGE]: article.image,
    [FIELDS.IMAGE_NAME]: article.imagename,
    [FIELDS.ARTIST]: article.artist,
