...
function saveAllCards(arr) {
  ...
  pendingWrites.push(
    writeFile('private/cardtree.json', JSON.stringify(util.turnToTree(_catalog.names)))
  );
  ...
  pendingWrites.push(
    writeFile('private/full_names.json', JSON.stringify(util.turnToTree(_catalog.full_names)))
  );
