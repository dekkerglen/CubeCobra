...
var grammar = function () {
    var o = function o(k, v, _o, l) {
        ...
        $V0 = [6, 10, 20, 22, 27, 39, 42, 47, 60, 63, 87, 88, 100, 102, 112, 113, 114, 120, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $V1 = [1, 7],
        $V2 = [6, 10, 14, 20, 22, 27, 39, 42, 47, 60, 63, 87, 88, 100, 102, 112, 113, 114, 120, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $V3 = [6, 10, 14, 20, 27, 39, 42, 47, 60, 63, 87, 88, 100, 102, 112, 113, 114, 120, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $V4 = [2, 16],
        $V5 = [1, 10],
        $V6 = [2, 8],
        $V7 = [1, 12],
        $V8 = [6, 10, 14, 20, 39, 42, 47, 60, 63, 87, 88, 100, 102, 112, 113, 114, 120, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $V9 = [2, 21],
        $Va = [1, 15],
        $Vb = [8, 178],
        $Vc = [1, 18],
        ...
        $VB = [1, 62],
        $VC = [1, 69],
        $VD = [6, 14, 39, 41, 47, 123, 125, 126],
        $VE = [6, 10, 20, 39, 41, 42, 47, 60, 63, 87, 88, 100, 102, 112, 113, 114, 120, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $VF = [1, 84],
        $VG = [1, 83],
        $VH = [10, 50, 52, 56],
        $VI = [52, 56],
        ...
        $VM = [1, 96],
        $VN = [1, 97],
        $VO = [10, 39, 47, 59, 60, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $VP = [10, 14, 39, 47, 59, 123, 125, 126, 138, 139],
        $VQ = [10, 14, 39, 47, 59, 60, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $VR = [14, 39, 47, 59, 123, 125, 126, 138, 139],
        $VS = [10, 14, 39, 47, 59, 60, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 142, 145, 146, 147, 148, 149, 150, 153],
        $VT = [10, 138, 139],
        $VU = [10, 14, 21, 50, 52, 56],
        $VV = [6, 41],
        $VW = [6, 10, 14, 20, 39, 41, 42, 47, 60, 63, 87, 88, 100, 102, 112, 113, 114, 120, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $VX = [10, 21, 41, 139, 164],
        $VY = [1, 135],
        $VZ = [1, 133],
        $V_ = [1, 134],
        ...
        $V41 = [1, 153],
        $V51 = [1, 152],
        $V61 = [8, 10, 56, 110, 123, 130, 131, 132, 133, 140, 152, 156, 174, 177, 178, 181, 184, 189, 190, 191],
        $V71 = [14, 39, 47, 59, 123, 125, 126],
        $V81 = [21, 41],
        $V91 = [1, 185],
        $Va1 = [1, 184],
        $Vb1 = [1, 181],
        ...
        $Ve1 = [21, 39, 47, 53],
        $Vf1 = [39, 59],
        $Vg1 = [10, 52, 56, 139, 164],
        $Vh1 = [126, 139, 142, 145, 146, 147, 148],
        $Vi1 = [1, 234],
        $Vj1 = [1, 235],
        $Vk1 = [1, 244],
        $Vl1 = [1, 249],
        ...
        $Vy1 = [1, 262],
        $Vz1 = [1, 261],
        $VA1 = [10, 21, 41, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 139, 164, 169],
        $VB1 = [10, 21, 41, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 139, 164, 167, 169],
        $VC1 = [14, 60],
        $VD1 = [2, 52],
        $VE1 = [1, 280],
        $VF1 = [10, 21, 41, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 139, 164],
        $VG1 = [41, 94, 95, 96, 97, 98, 99],
        $VH1 = [39, 53, 59, 117],
        $VI1 = [2, 121],
        $VJ1 = [8, 10, 14],
        $VK1 = [59, 123, 156],
        $VL1 = [8, 10, 14, 21, 39, 41, 47, 56, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 110, 111, 123, 130, 131, 132, 133, 139, 140, 152, 156, 160, 164, 167, 169, 172, 174, 177, 178, 181, 184, 189, 190, 191],
        $VM1 = [8, 10, 21, 41, 47, 56, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 110, 123, 130, 131, 132, 133, 139, 140, 152, 156, 164, 167, 169, 172, 174, 177, 178, 181, 184, 189, 190, 191],
        $VN1 = [8, 10, 14, 21, 41, 47, 56, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 110, 123, 130, 131, 132, 133, 139, 140, 152, 156, 164, 167, 169, 172, 174, 177, 178, 181, 184, 189, 190, 191],
        $VO1 = [56, 123, 152, 156, 181, 184, 189, 190, 191],
        $VP1 = [8, 10, 14, 21, 39, 41, 47, 56, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 110, 111, 123, 130, 131, 132, 133, 139, 140, 152, 156, 164, 167, 169, 172, 174, 177, 178, 181, 184, 189, 190, 191],
        $VQ1 = [10, 21, 41, 59, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 139, 164],
        $VR1 = [10, 39, 41, 42, 47, 60, 63, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $VS1 = [1, 349],
        $VT1 = [2, 67],
        $VU1 = [1, 351],
        $VV1 = [1, 352],
        ...
        $Vd2 = [1, 374],
        $Ve2 = [1, 375],
        $Vf2 = [41, 109, 110, 123, 156, 189, 190, 191],
        $Vg2 = [14, 39, 41, 47, 123, 125, 126],
        $Vh2 = [189, 190],
        $Vi2 = [1, 400],
        $Vj2 = [8, 10, 21, 41, 56, 59, 62, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 110, 123, 130, 131, 132, 133, 139, 140, 152, 156, 164, 167, 169, 174, 177, 178, 181, 184, 189, 190, 191],
        $Vk2 = [2, 39],
        $Vl2 = [14, 59, 62],
        $Vm2 = [2, 105],
        $Vn2 = [1, 431],
        ...
        $Vq2 = [1, 445],
        $Vr2 = [1, 446],
        $Vs2 = [59, 123, 139, 156, 172],
        $Vt2 = [14, 59, 123, 139, 156, 172],
        $Vu2 = [14, 39, 47],
        $Vv2 = [1, 477],
        $Vw2 = [1, 478],
        $Vx2 = [10, 14, 39, 41, 42, 47, 60, 63, 123, 125, 126, 129, 130, 131, 132, 133, 134, 138, 139, 140, 149, 150, 153],
        $Vy2 = [14, 59];
        ...
        performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
            ...
            switch (yystate) {
                ...
                case 222:
                    ...
                    this.$ = new yy.Func('attr', $$[$0 - 1] ? new yy.Expression([[null, $$[$0 - 3]]].concat($$[$0 - 1])) : $$[$0 - 3]);
                ...
                case 245:
                    ...
                    var exp = /[^\d]/.exec(parts[1][0]) ? parts[1].substr(1) : parts[1];
            ...
            performAction: function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
                ...
                switch ($avoiding_name_collisions) {
                    ...
                    case 24:
                        ...
                        break;
                    case 25:
                        return 10; // For cursor: n-resize
                        break;
                    case 26:
                        return 10; // For cursor: not-allowed
                        break;
                    case 27:
                        return 160;
                        break;
                    ...
                    case 64:
                        ...
                        break;
                    case 65:
                        yy_.yytext = yy_.yytext.substr(1, yy_.yyleng - 2);return 8;
                        break;
                    case 66:
                        yy_.yytext = yy_.yytext.substr(1, yy_.yyleng - 2);return 8;
                        break;
