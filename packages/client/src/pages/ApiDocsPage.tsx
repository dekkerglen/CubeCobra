            ...
            params={
              <>
                ...
                <Param name="date" type="query">
                  Unix timestamp in milliseconds. When provided, returns the cube as it was at the nearest changelog at
                  or before this date. Response includes a <InlineCode>changelog</InlineCode> field with the resolved
                  changelog ID and date.
                </Param>
              </>
            }
            responseExample={`{
  ...
  "default_sorts": ["Color Category", "Types-Multicolor", "Mana Value", "Alphabetical"]
            ...
            notes={
              <Text sm className="text-text-secondary">
                ...
                <InlineCode>changelog</InlineCode> field is only present when the <InlineCode>date</InlineCode> query
                parameter is used.
              </Text>
            }
          />
