...
const KEYWORD_REMINDER_TEXT: Record<string, string> = {
  ...
  enchant:
    'This can only be attached to the stated permanent, and moves to the graveyard if that permanent leaves play.',
  ...
  surveil:
    'Look at the top N cards of your library, then put any number of them into your graveyard and the rest back on top in any order.',
  fight: 'Each of the two creatures deals damage equal to its power to the other.',
  explore:
    'Reveal the top card of your library. Put a +1/+1 counter on this creature if it was a nonland card; otherwise put that card into your hand or leave it on top.',
  amass:
    "Put N +1/+1 counters on an Army you control, or create a 0/0 black Army creature token first if you don't have one.",
  ...
  proliferate:
    'Choose any number of permanents and/or players with a counter, then give each another counter of a kind already there.',
  ...
  monstrosity:
    "Put N +1/+1 counters on this creature and it becomes monstrous. Can't be activated if it's already monstrous.",
  ...
  detain:
    "Until your next turn, the detained permanent can't attack or block and its activated abilities can't be activated.",
  manifest:
    "Put the top card of your library onto the battlefield face down as a 2/2 creature. Turn it face up any time for its mana cost if it's a creature card.",
  ...
  buyback:
    'You may pay an additional cost; if you do, return this spell to your hand as it resolves instead of putting it in the graveyard.',
  ...
  cascade:
    'When you cast this spell, exile cards from the top of your library until you exile a cheaper nonland card, then you may cast it for free.',
  storm: 'When you cast this spell, copy it for each spell cast before it this turn.',
  suspend:
    'Rather than cast this card from your hand, you may pay its suspend cost and exile it with N time counters. Cast it for free when the last is removed.',
  ...
  megamorph:
    'You may cast this face down as a 2/2 for {3}. Turn it face up for its megamorph cost, and it gets a +1/+1 counter.',
  unearth:
    'You may pay the unearth cost to return this card from your graveyard to the battlefield. It gains haste, then is exiled at end of turn.',
  ...
  bestow:
    'You may cast this card for its bestow cost as an Aura. It becomes a creature again if it becomes unattached.',
  soulbond:
    'You may pair this creature with another unpaired creature when either enters; they share a bonus while paired.',
  extort: 'Whenever you cast a spell, you may pay {W/B} to drain each opponent for 1 life.',
  evolve:
    'Whenever a creature you control enters with greater power or toughness, put a +1/+1 counter on this creature.',
  ...
  embalm:
    'You may exile this card from your graveyard and pay its embalm cost to create a token copy of it. The token is white and has no mana cost.',
  ...
  escape:
    'You may cast this card from your graveyard for its escape cost, which includes exiling cards from your graveyard.',
  mutate:
    'You may cast this for its mutate cost, merging it with a target non-Human creature you own to form one mutated creature.',
  companion:
    "If your deck meets this card's condition, you may put it into your hand from outside the game once each game for {3}.",
  ...
  blitz:
    'You may cast this creature for its blitz cost. It gains haste and "when this dies, draw a card," and is sacrificed at end of turn.',
  casualty: 'As you cast this spell, you may sacrifice a creature with the stated power to copy the spell.',
  enlist:
    'As this creature attacks, you may tap a nonattacking creature you control to add its power to this creature.',
  reconfigure:
    "Attach this Equipment creature to a creature you control, or unattach it, as a sorcery. It isn't a creature while attached.",
  ...
  backup:
    "When this creature enters, put N +1/+1 counters on a target creature. If it's another creature, it also gains this creature's other abilities.",
  bargain: 'You may sacrifice an artifact, enchantment, or token as you cast this spell for an extra effect.',
  disguise:
    'You may cast this face down as a 2/2 with ward {2} for {3}. Turn it face up any time for its disguise cost.',
  cloak:
    "Put a card face down as a 2/2 creature with ward {2}. Turn it face up any time for its mana cost if it's a creature card.",
  plot: 'You may pay the plot cost and exile this card from your hand; cast it for free on a later turn.',
  saddle:
    'Tap any number of other creatures with total power N or more to saddle this Mount. It gets a bonus while saddled and attacking.',
...
const normalize = (keyword: string): string => keyword.toLowerCase().trim().replace(/[_-]+/g, ' ').replace(/\s+/g, ' ');
