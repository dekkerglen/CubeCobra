...
const cookiesHandler = (req: Request, res: Response) => {
  return render(req, res, 'InfoPage', {
...
export const routes = [
  {
    path: '/',
    method: 'get',
    handler: [csrfProtection, homeHandler],
  },
  {
    path: '/explore',
    method: 'get',
    handler: [csrfProtection, exploreHandler],
  },
  {
    path: '/queue',
    method: 'get',
    handler: [csrfProtection, queueHandler],
  },
  {
    path: '/dashboard',
    method: 'get',
  ...
  },
  {
    path: '/landing',
    method: 'get',
    handler: [csrfProtection, landingHandler],
  },
  {
    path: '/version',
    method: 'get',
    handler: [csrfProtection, versionHandler],
  },
  {
    path: '/contact',
    method: 'get',
    handler: [csrfProtection, contactHandler],
  },
  {
    path: '/tos',
    method: 'get',
    handler: [csrfProtection, tosHandler],
  },
  {
    path: '/filters',
    method: 'get',
    handler: [csrfProtection, filtersHandler],
  },
  {
    path: '/markdown',
    method: 'get',
    handler: [csrfProtection, markdownHandler],
  },
  {
    path: '/privacy',
    method: 'get',
    handler: [csrfProtection, privacyHandler],
  },
  {
    path: '/cookies',
    method: 'get',
    handler: [csrfProtection, cookiesHandler],
  },
  {
    path: '/donate',
    method: 'get',
    handler: [csrfProtection, donateHandler],
  },
  {
    path: '/c/:id',
    method: 'get',
    handler: [csrfProtection, cubeRedirectHandler],
  },
  {
    path: '/d/:id',
    method: 'get',
    handler: [csrfProtection, draftRedirectHandler],
  },
  {
    path: '/leave',
    method: 'get',
    handler: [csrfProtection, leaveHandler],
  },
  {
    path: '/ads.txt',
    method: 'get',
    handler: [csrfProtection, adsTxtHandler],
  },
];
