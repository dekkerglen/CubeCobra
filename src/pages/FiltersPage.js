...
function ContactPage({ loginCallback }) {
  return (
    <MainLayout loginCallback={loginCallback}>
      ...
      <Card className="my-3 mx-4">
          ...
          <table className="table">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  cards which are artifact creatures, or cards that aren't creatures and have &quot;create&quot; in
                  their oracle text.
                </td>
              </tr>
            </tbody>
        ...
        <Accordion title="Color and Color Identity">
          <p>
            You can find cards that are a certain color by using <code>c:</code> or <code>color:</code>, and cards with
            a certain color identity by using <code>ci:</code>, <code>id:</code> or <code>identity:</code>.
          </p>
          <p>
