    ...
    <MainLayout loginCallback={loginCallback}>
      ...
      <Card className="my-3 mx-4">
        ...
        <CardBody>
          ...
          <p>
            After becoming a patron, make sure to <a href="/user/account?nav=patreon">link your Cube Cobra account</a>{' '}
            to gain access to these benefits. If you are experiencing issues with your Patreon subscription, feel free
            to contact us on <a href="https://discord.gg/Hn39bCU">Discord</a>.
          </p>
