...
class CubeListNavbarRaw extends Component {
  ...
  render() {
    const { canEdit, cubeView, cubeID, hasCustomImages, filter, setFilter } = this.props;
    /* global */
    return (
      <div className="usercontrols">
        ...
        <FilterCollapse filter={filter} setFilter={setFilter} isOpen={this.props.openCollapse === 'filter'} />
