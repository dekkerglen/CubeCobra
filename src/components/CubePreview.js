...
const CubePreview = ({ cube }) => {
  ...
  return (
    <Card className={hover ? 'cube-preview-card hover' : 'cube-preview-card'} onClick={handleClick} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
      ...
      <div className="w-100 py-1 px-2">
        ...
        <em className="text-muted">
          Designed by <a data-sublink href={'/user/view/' + cube.owner}>{cube.owner_name}</a>
        </em>
      </div>
    </Card>
  );
