...
const TRAITS = Object.freeze([
  ...
  },
  {
    ...
    compute: (_0, card, _1, cards) => getRating(card, cards),
  },
  {
    ...
    compute: (_0, _1, picked, cards, _2, _3, pickedInCombination) =>
  ...
  },
  {
    ...
    weight: getSynergyWeight,
    compute: (_0, card, picked, cards, _1, _2, pickedInCombination) =>
  ...
  },
  {
    ...
    compute: (combination, _0, _1, _2, seen) => getOpenness(combination, seen),
  },
  {
    title: 'Color',
    tooltip: 'A score of how well these colors fit in with the current picks.',
    weight: getColorWeight,
    compute: (_0, _1, picked, cards, _2, _3, pickedInCombination, probabilities) =>
  ...
  },
  {
    ...
    compute: (combination, card, _, cards) => getFixing(combination, card, cards),
  },
  {
    ...
    compute: (_0, card, _1, cards, _2, lands) => getCastingProbability(cards[card], lands),
  },
  {
    title: 'Lands',
